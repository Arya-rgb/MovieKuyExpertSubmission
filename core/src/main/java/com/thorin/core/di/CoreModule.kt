package com.thorin.core.di

import androidx.room.Room
import com.thorin.core.data.FilmRepository
import com.thorin.core.data.source.local.LocalDataSource
import com.thorin.core.data.source.local.room.FilmDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("dickyganteng".toCharArray())
